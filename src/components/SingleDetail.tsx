...
const SingleDetails = ({product}:any) => {
  return (
    <main className=''>
        <div>
        ...
        <section className='flex w-full   md:w-[1363px] md:h-[100px] top-[114px] border border-[2px] border-[#9F9F9F]  items-center gap-9'>
            ...
            <div className='w-[142px] h-[37px] top-[145px] left-[312px] text-black border-l-[2px] border-[#9F9F9F] ml-8 flex items-center'>
              <p className='w-[108px] h-[24px] top-[151px] left-[346px] font-["Poppins"] font-normal  text-[16px] leading-[24px] text-black ml-5'>Sofa</p>
        ...
        <section className='w-full md:w-[1363px] md:h-[802px] top-[211px]'>
            <div className='flex flex-col w-[80%] md:flex-row md:w-[1200px] md:h-[730px] top-[246px] left-[99px] mt-10'>
                ...
                <div className='flex  flex-col-reverse gap-4 md:flex-row	 w-[100%] md:w-[553px] md:h-[500px] top-[246px] left-[99px] '>
                    ...
                    <div 
                    key={product.id}
                    className='flex items-center justify-center w-[80%] md:w-[481px] md:h-[500px] top-[246px] left-[171px] ml-10'>
                        <div className=' md:w-[423px] md:h-[500px] top-[246px] left-[206px] rounded-[10px] bg-[#FFF9E5]'>
                            <Image className=' ml-2 mt-5 h-[460px]'
                ...
                <div className=' w-full md:w-[606.01px] md:h-[730px] top-[246px] left-[734px] ml-10 '>
                    ...
                    <div className='w-full md:w-[600px] md:h-[730px] flex flex-col gap-[20px] '>
                        <h2 className='text-2xl md:w-[260px] h-[63px] top-[246px] left-[735px] font-["Poppins"] font-normal  md:text-[42px] leading-[63px] text-black '>{product.name}</h2>
                        <h2 className='text-2xl md:w-[173x] h-[36px] top-[309px] left-[735px] font-["Poppins"] font-medium  md:text-[24px] leading-[36px] text-[#9F9F9F] '>$ {product.price}</h2>
 ...
 {/* down side */}
        ...
        {/* section----3...................................................... */}
        <section className='flex w-full h-[800px] w-[90%] md:w-[1363px] md:h-[777px] top-[1031px] border-[1px] border-[#D9D9D9] flex-col md:items-center gap-10'>
            <div className='flex flex-col w-[80%] md:w-[649px] h-[36px] top-[1079px] left-[396px] '>
...
//         {/* Navigation Links */}
//         <div className="w-[82px] h-[24px] top-[152px] left-[99px] flex mx-10 gap-2">
//           <Link href="/"> <p className="w-[48px] h-[24px] font-['Poppins'] text-[16px]">Home</p></Link>
//           <span className="pt-1"> <IoIosArrowForward /> </span>
//           <Link href="/shop"> <p className="w-[48px] h-[24px] font-['Poppins'] text-[16px]">Shop</p></Link>
//           <span className="pt-1"> <IoIosArrowForward /> </span>
//         </div>
//         <div className="w-[142px] h-[37px] ml-8 text-black">
//           <p className="w-[108px] h-[24px] font-['Poppins'] text-[16px]">{product.category}</p>
//         </div>
//       </section>

//       <section className="w-full md:w-[1363px] md:h-[802px] mt-10">
//         <div className="flex flex-col md:flex-row w-[80%] md:w-[1200px] md:h-[730px] gap-4">
//           {/* Left Section: Image */}
//           <div className="flex items-center justify-center w-[80%] md:w-[481px] md:h-[500px] ml-10">
//             <div className="rounded-[10px] bg-[#FFF9E5]">
//               <Image
//                 className="ml-2 mt-5 h-[460px]"
//                 src={product.imagepath}
//                 width={400}
//                 height={200}
//                 alt={product.name}
...
//           <div className="w-full md:w-[606px] md:h-[730px] ml-10">
//             <h2 className="text-2xl md:text-[42px] text-black">{product.name}</h2>
//             <h2 className="text-2xl text-[#9F9F9F]">${product.price}</h2>
...
//               <span className="rounded-full bg-violet-800 w-[30px] h-[30px]"></span>
//               <span className="rounded-full bg-black w-[30px] h-[30px]"></span>
//               <span className="rounded-full bg-[#FBEBB5] w-[30px] h-[30px]"></span>
//             </div>

//             <div className="flex gap-5 mt-4">
//               <div className="border-[1px] border-[#9F9F9F] flex items-center justify-center">
//                 <span>-</span>
//                 <p>1</p>
//                 <span>+</span>
//               </div>
//               <button className="border-[1px] border-[#9F9F9F]">Add to Cart</button>
//             </div>
//           </div>
//         </div>
//       </section>
